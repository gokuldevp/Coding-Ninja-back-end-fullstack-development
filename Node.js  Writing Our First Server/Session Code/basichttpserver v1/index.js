...
let requestHandler_1 = (request, response) => {
    //Function to handle the server request and response when rendering text
...
let requestHandler_2 = (request, response) => {
    //Function to handle the server request and response when rendering html
    console.log(request.url);  // log the url part of the request, the area after the port
...
let requestHandler_3 = (request, response) => {
    ...
    const path = "./index.html";    //Path of the Html file
...
const server = http.createServer(requestHandler_3);  // createing http server request
